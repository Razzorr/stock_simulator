...
class OHLCVGraph extends StatelessWidget {
  ...
  /// OHLCV data to graph  /// List of Maps containing open, high, low, close and volume
  /// Example: [["open" : 40.0, "high" : 75.0, "low" : 25.0, "close" : 50.0, "volume" : 5000.0}, {...}]
  final List data;
...
class _OHLCVPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (enableGridLines) {
      ...
      gridLineY = (gridLineDist * 0).round().toDouble();
      // Label volume line
